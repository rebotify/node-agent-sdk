...
class SDK extends Events {
     ...
     */
    request(type, body, headers, metadata, encodedMetadata, callback) {
    ...
    registerRequests(arr) {
        arr.forEach(reqType => this[utils.toFuncName(reqType)] = (body, headers, metadata, encodedMetadata, callback) => this.request(reqType, body, headers, metadata, encodedMetadata, callback));
    }
